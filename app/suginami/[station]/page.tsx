...
const STATIONS: Record<string, { name: string; title: string; desc: string }> = {
  ogikubo: {
    ...
    desc: '荻窪の駐車場あり飲食店20選。専用駐車場・提携駐車場で安心。ランチ・ディナー・ファミリーにおすすめの荻窪周辺レストランを厳選紹介。',
  },
  asagaya: {
    name: '阿佐ヶ谷',
    title: '阿佐ヶ谷 駐車場付きレストラン【確認済み】',
    desc: '阿佐ヶ谷の駐車場あり飲食店17選。専用駐車場・提携駐車場完備の飲食店を厳選。ファミリー・グループでのランチ・ディナーにおすすめ。',
  },
  nishiogikubo: {
    name: '西荻窪',
    title: '西荻窪 駐車場付きレストラン【確認済み】',
    desc: '西荻窪の駐車場あり飲食店11選。専用駐車場完備で車でも安心。子連れ・ファミリーでのランチ・ディナーにおすすめの西荻窪レストラン。',
  },
  koenji: {
    name: '高円寺',
    title: '高円寺 駐車場付きレストラン【確認済み】',
    desc: '高円寺の駐車場あり飲食店15選。専用駐車場・提携駐車場で安心。ランチ・ディナー・家族連れにおすすめの高円寺周辺飲食店を厳選。',
  },
  hamadayama: {
    name: '浜田山',
